    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_android') ? 'is-invalid' : '' }}" type="number" name="price_android" id="price_android" value="{{ old('price_android', $product->price_android) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_ios') ? 'is-invalid' : '' }}" type="number" name="price_ios" id="price_ios" value="{{ old('price_ios', $product->price_ios) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('trial') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="trial" id="trial" value="1" {{ $product->trial || old('trial', 0) === 1 ? 'checked' : '' }}>
